...
public class ProjectConfig implements WebMvcConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests( (request) -> request.requestMatchers("/","/login","/js/**","/webjars/**","/registro/**","/carrito/**")
                                    .permitAll()
                                    .requestMatchers("/categoria/listado","/producto/listado")
                                    .hasRole("VENDEDOR")
                                    .requestMatchers("/categoria/nuevo","/categoria/modificar/**","/categoria/eliminar/**","/categoria/guardar","/producto/nuevo","/producto/modificar",
...
//        UserDetails admin = User.builder().username("juean")
//                    .password("{noop}123")
//                    .roles("USER","VENDEDOR","ADMIN")
//                    .build();
//        
//        UserDetails vendedor = User.builder().username("juean")
//                    .password("{noop}456")
//                    .roles("USER","VENDEDOR")
//                    .build();
//        
//        UserDetails usuario = User.builder().username("juean")
//                    .password("{noop}789")
//                    .roles("USER")
//                    .build();
//        
